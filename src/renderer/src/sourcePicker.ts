import { WindowSource, SourceType } from '../../types/capture';
...
export class SourcePicker {
  ...
  constructor(containerElement: HTMLElement, onSelectCallback: (source: WindowSource) => void) {
  ...
  public render(): void {
    ...
    const filtered = this.sources.filter((s) => s.sourceType === this.currentFilter);
